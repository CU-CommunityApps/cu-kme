...
public class Session implements Serializable, Comparable<Session> {
	...
	private String dateCSSClass;
	private String dateTimeCSSClass;
	...
	public void setDateCSSClass(String dateCSSClass) {
		this.dateCSSClass = dateCSSClass;
	}

	public String getDateTimeCSSClass() {
		return dateTimeCSSClass;
	}
	...
	public int compareTo(Session that) {
		...
		if (this.getDateTimeCSSClass() == null && that.getDateTimeCSSClass() == null) {
			return -1;
		}
		...
		int dateTimeCSSClassCompare = this.getDateTimeCSSClass().compareTo(that.getDateTimeCSSClass());
		if (dateTimeCSSClassCompare == 0) {
		...
		return dateTimeCSSClassCompare;
	}
