...
<kme:page title="${title}" id="home" appcacheFilename="kme.appcache" cssFilename="home" backButton="false" homeButton="false" preferencesButton="true" preferencesButtonURL="campus?toolName=home" loginButton="true" loginButtonURL="home?login=yes">
	<kme:content>
