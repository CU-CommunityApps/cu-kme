...
<kme:page title="${title}" id="home" manifestFilename="kme.appcache" backButton="false" homeButton="false" preferencesButton="true" preferencesButtonURL="campus?toolName=home" loginButton="true" loginButtonURL="home?login=yes">
	<kme:content>
